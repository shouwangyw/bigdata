...
/**
 * 数据生成
 * 比例确定如果有 10000 条记录，则有一千个用户、100个app
...
object DataGenerator {
  def main(args: Array[String]) {
    ...
    // 1. 应用词表
    makeList(10000, "machine-learning/data/recommend")
    // 2. 用户历史下载
    makeAppDown(10000, "machine-learning/data/recommend")
    // 3. 模拟正负例样本 = 浏览记录 + label
    makeSample(10000, "machine-learning/data/recommend")
  }
