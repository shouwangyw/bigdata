...
//    idfModel.write.overwrite().save("hdfs://node1:9000/recommend/program/models/IDF.model")
    idfModel.write.overwrite().save("/recommend/program/models/IDF.model")
     ...
     * word: idf值
     */
//    session.read.parquet("hdfs://node1:9000/recommend/program/models/IDF.model/data")
    session.read.parquet("/recommend/program/models/IDF.model/data")
      .show(10, false)
