...
//    /** 使用HiveCatalog **/
//    // 1. 创建表，hive_prod: 指定catalog名称，default: 指定hive中存在的库，test: 创建iceberg表名
//    spark.sql(
//      """
...
//    spark.sql(
//      """
//        | insert into hive_prod.default.test values(1, 'zhangsan', 23),(2, 'lisi', 14),(3, 'wangwu', 35)
//        |""".stripMargin)
//
//    // 3. 查询数据
//    spark.sql(
...
//
//    /** 使用HadoopCatalog **/
//    // 1. 创建表，hadoop_prod: 指定catalog名称，default: 指定库名称，test: 创建iceberg表名
//    spark.sql(
//      """
