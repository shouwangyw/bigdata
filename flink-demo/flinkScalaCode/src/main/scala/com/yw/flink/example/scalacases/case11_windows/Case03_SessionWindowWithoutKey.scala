...
/**
  ...
  */
object Case03_SessionWindowWithoutKey {
  def main(args: Array[String]): Unit = {
    ...
    dsWithWatermark.windowAll(EventTimeSessionWindows.withGap(Time.seconds(3)))
      .process(new ProcessAllWindowFunction[StationLog, String, TimeWindow] {
        override def process(context: Context,
          ...
          out.collect(s"窗口范围：[$startTime~$endTime),总通话时长:$totalDurationTime")
