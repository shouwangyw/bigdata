...
public class Case11_Window {
    public static void main(String[] args) throws Exception {
        ...
        SingleOutputStreamOperator<String> result = keyedStream.window(TumblingEventTimeWindows.of(Time.seconds(5))).process(new ProcessWindowFunction<StationLog, String, String, TimeWindow>() {
            @Override
